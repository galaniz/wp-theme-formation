...
<table>
	...
	<tbody>
		...
		<tr id="cpt">
			...
			<td><code>[]</code></td>
			<td>✓</td>
			<td>Store post type names and data (can add custom key => pair values).<pre lang="php">self::$cpt['custom_post_type'] = [
	...
	'ajax_posts_per_page' => true // add field in reading settings to select number of posts to load with ajax
		...
		<tr>
			...
			<td><code>[]</code></td>
			<td></td>
			<td>Editor color palette theme support args.
<pre lang="php">
	$this->editor_color_palette[] = [
		...
		<tr>
			...
			<td><code>[]</code></td>
			<td></td>
			<td>Stylesheets to register. See <a href="https://developer.wordpress.org/reference/functions/wp_enqueue_style/">wp_enqueue_style</a>.
<pre lang="php">
	$this->styles = [
		[
			'handle' => 'fonts',
		...
		<tr>
			...
			<td><code>[]</code></td>
			<td></td>
			<td>Scripts to register. See <a href="https://developer.wordpress.org/reference/functions/wp_enqueue_script/">wp_enqueue_script</a>.
<pre lang="php">
	$this->scripts = [
		[
			'handle' => 'scripts',
